            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-2">Reset Password</p>
            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                ...
                @endif
                      ...
                      <form action="/renew-password" method="post">
                          @csrf
                          
                          <input type="hidden" name="user_mail" value="{{ $mail->email }}">
                          <div class="form-floating mb-3">
                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="passwordd" placeholder="New Password" required>
                          ...
                          <div class="form-floating mb-3">
                            <input type="password" name="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" id="confirm_password" placeholder="New Password" required>
                          ...
                          <button class="w-100 btn btn-lg btn-light" style="background-color: #F9A826;" type="submit">Confirm</button>
                      </form>
